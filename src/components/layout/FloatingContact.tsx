...
const FloatingContact = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {isOpen && (
        <div className="absolute bottom-16 right-0 bg-white rounded-lg shadow-xl p-4 mb-2 min-w-[200px]">
          <a
          ...
          <a
            href="mailto:tamutcca@gmail.com"
            className="flex items-center space-x-2 p-2 hover:bg-gray-100 rounded-lg transition-colors mt-2"
          >

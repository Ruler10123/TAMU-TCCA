        ...
        <div className="mt-12 max-w-lg mx-auto">
          {submitted ? (
            <div className="text-center p-8 bg-emerald-50 rounded-lg">
              ...
              <h3 className="mt-4 text-lg font-medium text-gray-900">Thank you for your interest!</h3>
              <p className="mt-2 text-gray-500">We&apos;ll get back to you soon. Meanwhile, feel free to join our Discord community!</p>
              <a
          ...
          <div className="mt-8 prose prose-emerald">
            <h3 className="text-lg font-medium text-emerald-600">Other Ways to Connect</h3>
            <ul className="mt-4 space-y-2">
              <li>
                <a href="https://discord.gg/gZ9f4Cu" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:text-emerald-700">
                  Join our Discord Community
                </a>
              </li>
              <li>
                <a href="https://www.facebook.com/tamutzuchi/" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:text-emerald-700">
